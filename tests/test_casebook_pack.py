"""Regression checks for the csharp-metrics casebook."""
...
from casebook.harness import assert_expected, csharp_metrics_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(csharp_metrics_summary(), assert_expected())
