...
`csharp-metrics` is centered on observability work in C#. The technical target is: Expose counters, gauges, histograms, and text-format fixtures.
...
The score is deterministic. The current threshold is 151. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 6.
