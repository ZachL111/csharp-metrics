...
csharp-metrics is a C# project for observability. It focuses on this technical goal: Expose counters, gauges, histograms, and text-format fixtures.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 151, risk penalty 5, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
